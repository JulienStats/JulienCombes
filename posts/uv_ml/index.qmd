...
In order to manage the part with GPU compatibilities, uv provides an [help page](https://docs.astral.sh/uv/guides/integration/pytorch/) to get the torch versions matching your locally installed cuda : 
...
In the case you do not want to setup a big project with requirements for long term re use, but only a small env for fast and easy data analysis for example.
You just need to run this command to open a notebook using the env created in previous steps, in this way, you do not need more setup than this.
