...
In most cases you will already have a file produced by some measurement system. 
...
Pandas provides a lot of very useful methods to filter, modify delete items from a dataframe.
...
There is an important part of python that is usually quite useless but we will have to use it here : Anonymous function. It is when you want to use a function with as input to another function but not use it as itself.
