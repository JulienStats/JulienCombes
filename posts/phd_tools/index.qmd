...
- [Torchcp](https://github.com/ml-stat-Sustech/TorchCP) : Library that contains the boilerplate to quantificate the uncertainty one gpu. I prefer to use this lib since all algorithms can be ran on GPU, and that is a requirement in computer vision.