...
one the cpu of your computer or on ten H100 of any cloud you could get access to. 
...
The metrics have the gathering across gpus/device already implemented so you just have to decide of which ones you want to add to your project. If some computations are not already present in the library, you can [add your own metric](https://lightning.ai/docs/torchmetrics/stable/pages/implement.html) very easily.
